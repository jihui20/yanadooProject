...
class EventList extends Component {
    constructor(props) {
        ...
        this.state = {
            tabClick: true,
            list: [
                {id: 1, title: '야나두x와디즈 최초 공개! 진짜 현업에서 쓰는 야나두 비즈니스 응급 키트! 4월 한달동안만 진행!', dDay: '4', period: '21.04.12(월) ~ 21.04.18(일)', announcement: '21.04.25(월)'},
                {id: 2, title: '진짜 현업에서 쓰는 야나두 비즈니스 응급 키트!', dDay: '66',period: '21.04.12(월) ~ 21.04.18(일)', announcement: '21.04.25(월)'},
                {id: 3, title: '4월 한달동안만 진행!', dDay: '100',period: '21.04.12(월) ~ 21.04.18(일)', announcement: '21.04.25(월)'},
                {id: 4, title: '야나두x와디즈 최초 공개!', dDay: '78',period: '21.04.12(월) ~ 21.04.18(일)', announcement: '21.04.25(월)'},
            ],
        }
    }
